        ...
        while True:
            ...
            if not len(self.enemies):
                ...
                if self.transition > 30:
                    self.level = min(self.level + 1, len(os.lisdir('data/maps')) -1) # 
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN: #if the player press key turn true
                    ...
                    if event.key == pygame.K_w:
                        self.player.jump()                      #velocity[1] = -3 -> the other way of jumping
            ...
            self.screen.blit(pygame.transform.scale(self.display, self.screen.get_size()), screenshake_offset) # use to be (0, 0)
